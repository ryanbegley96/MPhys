...
y_data1 = 1.086*np.log(f_intrins_norm/f_fake1)
y_data2 = 1.086*np.log(f_intrins_norm/f_fake2)
y_data_err = np.full(f_intrins_norm.shape, 0.001)

print(lambda_fake,y_data1)
...
popt1, pcov1 = curve_fit(model_curve, (1./lambda_fake), y_data1, sigma=y_data_err)
print('Fitted params a0,a1,A_598 are -'+str(popt1))
popt2, pcov2 = curve_fit(model_curve, (1./lambda_fake), y_data2, sigma=y_data_err)
...
#plot for data + fit against 1/lambda
plt.figure()
